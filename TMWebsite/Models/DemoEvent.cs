...
namespace TMWebsite.Models
{
    public class DemoEvent
    {
        ...
        public string[] lienquan { set; get; }
        ...
        public List<DemoEvent> getDataExamble()
        {
            ...
            events.Add(new Models.DemoEvent()
            {
                ...
                chude = "Họp giao ban",
                lienquan = new string[] { "PGD Nguyễn Văn A", "TPKD Nguyễn Văn B", "Phòng Kỹ Thuật" },
            ...
            events.Add(new Models.DemoEvent()
            {
                ...
                diachi = "42 Đinh Tiên Hoàng",
                chude = "", 
                lienquan = new string[] { "TP Nguyễn Văn A", "Phòng Kỹ Thuật" },
                ...
                files = new string[] { "truongphongphatbieu.pdf","ketluan.pdf," }
            });
            return events;
        }
    }
