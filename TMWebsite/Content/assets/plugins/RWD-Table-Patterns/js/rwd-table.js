...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownBtn = $('<button class="btn btn-secondary waves-effect dropdown-toggle" data-toggle="dropdown">Display <span class="caret"></span></button>');
        ...
        if(this.options.addFocusBtn) {
            ...
            // Create focus btn
            this.$focusBtn = $('<button class="btn btn-secondary waves-effect">Focus</button>');
        ...
        if(this.options.addDisplayAllBtn) {
            ...
            this.$displayAllBtn = $('<button class="btn btn-secondary waves-effect">Display all</button>');
